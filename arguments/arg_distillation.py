...
parser.add_argument('--seed', default=2, type=int, help='random seed for training')
...
parser.add_argument('--gpu', type=int, default=0, help='for selete gpu') 
parser.add_argument('--record_iters', type=int, default=500) 
parser.add_argument('--num_slices', type=int, default=2048, help='number of projection dimension') 
